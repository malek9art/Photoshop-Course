...
| C-08 | Assessment Module | 🟩 Implemented (v0.4) | Prototype | B-04 (quiz) + B-07 (exams) + B-08 (retake rules DOC-08 §5: attempts/cooldown/best-score) | /api/quiz + /api/exam (ADR-010) |
...
|---------|------|--------|--------------------|
| 1.0.7 | 2026-08-01 | AGT-003 | C-08 v0.4: retake enforcement (DOC-08 §5) after batch B-08 (CHG-009). |
